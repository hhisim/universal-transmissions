...
import { Crown, Zap, Star, CheckCircle, ArrowRight, Shield } from 'lucide-react'
    ...
    <>
      ...
      <main className="min-h-screen pt-24 pb-20" style={{ background: 'var(--ut-black, #0a090e)', position: 'relative' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto', padding: '0 24px 80px' }}>
          ...
          {/* My status — logged in, non-initiate */}
          {session && plan !== 'initiate' && (
            <div className="mb-8 p-4 text-center" style={{
              ...
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 13, color: 'rgba(237,233,246,0.5)' }}>
                Today: {usage} / {limit === 'unlimited' ? '∞' : limit} questions used
              </div>
              {plan === 'free' && (
