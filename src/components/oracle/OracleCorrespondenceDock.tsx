  ...
  return (
    ...
    >
        ...
        <aside className="oracle-dock-context oracle-v12-right">
          {query.trim() ? (
            ...
            <>
              ...
              <div className="oracle-system-focus">
      ...
      <style>{`
        ...
        .oracle-dock-body { grid-template-columns: 260px minmax(0,1fr) 380px; gap: 14px; margin-top: 0; }
        ...
        .oracle-v12-system-list { display:grid; gap:5px; max-height:245px; overflow:auto; padding-right:3px; }
        ...
        .oracle-system-collection { display:grid; gap:7px; max-height:260px; overflow:auto; padding-right:2px; }
        ...
        .oracle-symbol-cloud { grid-template-columns:repeat(auto-fill,minmax(88px,1fr)); max-height:360px; }
        ...
        .oracle-v12-field-matrix { display:grid; gap:5px; margin-top:10px; max-height:330px; overflow:auto; padding-right:2px; }
