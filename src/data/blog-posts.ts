...
export const blogPosts: BlogPost[] = [
  ...
  // ── Old-Squarespace Posts (chronological) ────────────────────────────────────────
  {
    ...
    author: "Hakan Hisim",
    excerpt: "An early Universal Transmissions process note about receiving new visual transmissions and the works beginning to take shape.",
    readTime: "1 min",
  ...
  },
  {
    ...
    author: "Hakan Hisim",
    excerpt: "An early sketch exploring the Trivium Method as part of the Universal Transmissions process, captured while the work was still developing.",
    readTime: "1 min",
    hero_gradient: "from-purple-950 via-fuchsia-900 to-black",
