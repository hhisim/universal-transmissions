...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    author: "Hakan Hisim",
    excerpt: "Album artwork created for Kolm's YÜGEN release — a visual transmission in the UT aesthetic.",
    readTime: "1 min",
    heroImage: "https://www.universal-transmissions.com/email/yugen-kolm.jpg",
    hero_gradient: "from-fuchsia-950 via-purple-950 to-black",
